...
const ConverterForm = () => {
    ...
    const getExchangeRate = async () => {
        ...
        const API_KEY = "6db4d358e808abcdded7cb7f";
    ...
    return (
        <form className="converter-form" onSubmit={handleFormSubmit}>
            ...
            <div className="form-group form-currency-group">
                ...
                <div className="swap-icon mx-2" onClick={handleSwapCurrencies}>
            ...
            <button type="submit" className={`${isLoading ? "loading" : ""} submit-button bg-white text-black`}>Get Exchange Rate</button>
